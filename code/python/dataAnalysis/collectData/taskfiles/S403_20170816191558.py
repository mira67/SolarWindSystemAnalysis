...
allDevice=[
  {
    ...
    "DeviceModeCode": 6,
    "DeviceCode": 1,
    "DeviceFullCode": "403M201M6M1",
    "DeviceModeFullCode": "403M201M6",
  ...
  },
  {
    ...
    "DeviceModeCode": 9,
    "DeviceCode": 1,
    "DeviceFullCode": "403M203M9M1",
    "DeviceModeFullCode": "403M203M9",
    "PDeviceFullCode": None,
    "Capacity": None
  },
  {
    ...
    "DeviceModeCode": 21,
    "DeviceCode": 1,
    "DeviceFullCode": "403M302M21M1",
    "DeviceModeFullCode": "403M302M21",
    "PDeviceFullCode": None,
    "Capacity": 3400.0000
  },
  {
    ...
    "DeviceModeCode": 27,
    "DeviceCode": 1,
    "DeviceFullCode": "403M505M27M1",
    "DeviceModeFullCode": "403M505M27",
    "PDeviceFullCode": None,
    "Capacity": None
  },
  {
    ...
    "DeviceModeCode": 1,
    "DeviceCode": 1,
    "DeviceFullCode": "403M801M1M1",
    "DeviceModeFullCode": "403M801M1",
    "PDeviceFullCode": None,
    "Capacity": None
  }
]
    ...
    def ___calcWeatherStation(self): 
        try:  
            ...
            for  device203  in alldevice203:
                ...
                if(device203['DeviceFullCode']=="403M203M9M1"):  
        ...
        try:
            ...
            for  deviceItem  in allDeviceTypeDevice:
                try:
                    ...
                    if deviceTypeCode==203 and deviceItem['DeviceFullCode']=="403M203M9M1":
                        self.Tilted_Surf_Radi_Avg=data.get('Tilted_Surf_Radi_Avg')
                        self.Tilted_Surf_Radi_Std=data.get('Tilted_Surf_Radi_Std')
                        self.STC_rad_Avg=data.get('STC_rad_Avg')
                except BaseException as err:
