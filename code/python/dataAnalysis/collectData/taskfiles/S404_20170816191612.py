...
allDevice=[
  {
    ...
    "DeviceModeCode": 6,
    "DeviceCode": 1,
    "DeviceFullCode": "404M201M6M1",
    "DeviceModeFullCode": "404M201M6",
    "PDeviceFullCode": "404M204M2M1",
    "Capacity": 680.0000
  },
  {
    "DeviceTypeCode": 201,
    "DeviceModeCode": 7,
    "DeviceCode": 2,
    "DeviceFullCode": "404M201M7M2",
    "DeviceModeFullCode": "404M201M7",
    "PDeviceFullCode": "404M204M2M1",
    "Capacity": 680.0000
  },
  {
  ...
  },
  {
    ...
    "DeviceModeCode": 9,
    "DeviceCode": 1,
    "DeviceFullCode": "404M203M9M1",
    "DeviceModeFullCode": "404M203M9",
  ...
  },
  {
    ...
    "DeviceModeCode": 21,
    "DeviceCode": 1,
    "DeviceFullCode": "404M302M21M1",
    "DeviceModeFullCode": "404M302M21",
    "PDeviceFullCode": None,
    "Capacity": 2720.0000
  },
  {
    ...
    "DeviceModeCode": 27,
    "DeviceCode": 1,
    "DeviceFullCode": "404M505M27M1",
    "DeviceModeFullCode": "404M505M27",
    "PDeviceFullCode": None,
    "Capacity": None
  },
  {
    ...
    "DeviceModeCode": 1,
    "DeviceCode": 1,
    "DeviceFullCode": "404M801M1M1",
    "DeviceModeFullCode": "404M801M1",
    "PDeviceFullCode": None,
    "Capacity": None
  }
]
    ...
    def ___calcWeatherStation(self): 
        try:  
            ...
            for  device203  in alldevice203:
                ...
                if(device203['DeviceFullCode']=="404M203M9M1"):  
        ...
        try:
            ...
            for  deviceItem  in allDeviceTypeDevice:
                try:
                    ...
                    if deviceTypeCode==203 and deviceItem['DeviceFullCode']=="404M203M9M1":
                        self.Tilted_Surf_Radi_Avg=data.get('Tilted_Surf_Radi_Avg')
                        self.Tilted_Surf_Radi_Std=data.get('Tilted_Surf_Radi_Std')
                        self.STC_rad_Avg=data.get('STC_rad_Avg')
                except BaseException as err:
