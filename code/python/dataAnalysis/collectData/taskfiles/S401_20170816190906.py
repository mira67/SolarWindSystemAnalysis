...
deviceModePointConfig=[
  ...
  },
  {
    ...
    "DeviceModePointName": "加权平均POA辐照强度",
    "CalcMethod": "Avg",
    "Divation": 600
  },
  {
  ...
  },
  {
    ...
    "DeviceModePointName": "加权平均温度标度辐照强度",
    "CalcMethod": "Avg",
    "Divation": 600
  },
  {
...
allDevice=[
  {
    ...
    "DeviceModeCode": 15,
    "DeviceCode": 1,
    "DeviceFullCode": "401M201M15M1",
    "DeviceModeFullCode": "401M201M15",
  ...
  },
  {
    ...
    "DeviceModeCode": 14,
    "DeviceCode": 1,
    "DeviceFullCode": "401M202M14M1",
    "DeviceModeFullCode": "401M202M14",
    "PDeviceFullCode": None,
    "Capacity": None
  },
  {
  ...
  },
  {
    ...
    "DeviceModeCode": 9,
    "DeviceCode": 1,
    "DeviceFullCode": "401M203M9M1",
    "DeviceModeFullCode": "401M203M9",
    "PDeviceFullCode": None,
    "Capacity": None
  },
  {
    ...
    "DeviceModeCode": 1,
    "DeviceCode": 1,
    "DeviceFullCode": "401M801M1M1",
    "DeviceModeFullCode": "401M801M1",
    "PDeviceFullCode": None,
    "Capacity": None
  }
]
    ...
    def ___calcWeatherStation(self): 
        try:  
            ...
            for  device203  in alldevice203:
                ...
                if(device203['DeviceFullCode']=="401M203M9M1"):  
        ...
        try:
            ...
            for  deviceItem  in allDeviceTypeDevice:
                try:
                    ...
                    if deviceTypeCode==203 and deviceItem['DeviceFullCode']=="401M203M9M1":
                        self.Tilted_Surf_Radi_Avg=data.get('Tilted_Surf_Radi_Avg')
                        self.Tilted_Surf_Radi_Std=data.get('Tilted_Surf_Radi_Std')
                        self.STC_rad_Avg=data.get('STC_rad_Avg')
                except BaseException as err:
