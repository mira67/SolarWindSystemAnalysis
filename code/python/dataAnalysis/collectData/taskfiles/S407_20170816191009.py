...
allDevice=[
  {
    ...
    "DeviceModeCode": 16,
    "DeviceCode": 1,
    "DeviceFullCode": "407M201M16M1",
    "DeviceModeFullCode": "407M201M16",
    "PDeviceFullCode": "407M204M2M1",
    "Capacity": 750.0000
  },
  {
    "DeviceTypeCode": 201,
  ...
  },
  {
    ...
    "DeviceModeCode": 9,
    "DeviceCode": 1,
    "DeviceFullCode": "407M203M9M1",
    "DeviceModeFullCode": "407M203M9",
  ...
  },
  {
    ...
    "DeviceModeCode": 1,
    "DeviceCode": 1,
    "DeviceFullCode": "407M801M1M1",
    "DeviceModeFullCode": "407M801M1",
    "PDeviceFullCode": None,
    "Capacity": None
  }
]
    ...
    def ___calcWeatherStation(self): 
        try:  
            ...
            for  device203  in alldevice203:
                ...
                if(device203['DeviceFullCode']=="407M203M9M1"):  
        ...
        try:
            ...
            for  deviceItem  in allDeviceTypeDevice:
                try:
                    ...
                    if deviceTypeCode==203 and deviceItem['DeviceFullCode']=="407M203M9M1":
                        self.Tilted_Surf_Radi_Avg=data.get('Tilted_Surf_Radi_Avg')
                        self.Tilted_Surf_Radi_Std=data.get('Tilted_Surf_Radi_Std')
                        self.STC_rad_Avg=data.get('STC_rad_Avg')
                except BaseException as err:
